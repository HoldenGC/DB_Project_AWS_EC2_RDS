    ...
    if ($result = $mysqli->query($sql)) {
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_array()) {
                ...
                echo "<a href='UglyBookRead.php?BookID=" . $row['BookingID'] . "' title='View Record' data-toggle='tooltip'><span class='fas fa-eye'> View </span></a>";
                echo "<a href='UglyBookUpdate.php?BookID=" . $row['BookingID'] . "' title='Update Record' data-toggle='tooltip'><span class='fas fa-pencil-alt'></i>&nbspUpdate&nbsp</span></a>";
                echo "<a href='UglyBookDelete.php?BookID=" . $row['BookingID'] . "' title='Delete Record' data-toggle='tooltip'><span class='fas fa-trash-alt'>&nbspDelete&nbsp</span></a>";
                echo "</td>";
                echo "</tr>";
            }
            echo "</tbody>";
